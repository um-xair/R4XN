        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[20%_20%_20%_40%] gap-8">
            <div>
                ...
                <ul class="space-y-6">
                    ...
                    <li><a href="projects.php" class="text-[#737373] text-sm hover:text-white transition-all duration-500 hover-underline">Front-End Projects</a></li>
                    <li><a href="iot.php" class="text-[#737373] text-sm hover:text-white transition-all duration-500 hover-underline">IoT Solutions</a></li>
                    <li><a href="system.php" class="text-[#737373] text-sm hover:text-white transition-all duration-500 hover-underline">System Design</a></li>
                </ul>
            </div>
            <div>
