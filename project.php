...
<body class="bg-[#f4f4f4] dark:bg-[#080808] m-0 flex flex-col items-center justify-start text-black dark:text-white overflow-auto">

    <?php include 'header.php';?>

    <!-- Link-wrapped cards with animation class -->
    <section class="min-h-screen px-6 py-32 flex flex-col items-center justify-center text-black dark:text-white">
        <div class="space-y-16">
            <h2 class="text-transparent bg-gradient-to-t from-gray-600 to-black dark:from-gray-400 dark:to-white bg-clip-text leading-tight font-bold text-4xl md:text-8xl text-center">
                <div>Our Digital Showcase</div>
            </h2>
            <div id="projectCards" class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl w-full">
            <a href="frontend.php" class="group card-link">
                <div class="flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white hover:text-black transition duration-300 h-full">
                    ...
                    <h3 class="text-2xl md:text-4xl font-bold group-hover:text-black">Frontend Projects</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black">Bringing ideas to life through engaging, user-first frontend experiences.</p>
                </div>
            </a>
            <a href="system.php" class="group card-link">
                <div class="flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white hover:text-black transition duration-300 h-full">
                    ...
                    <h3 class="text-2xl md:text-4xl font-bold group-hover:text-black">System Design</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black">Merging aesthetics with logic to deliver high-performing systems.</p>
                </div>
            </a>
            <a href="iot.php" class="group card-link">
                <div class="flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white hover:text-black transition duration-300 h-full">
                    ...
                    <h3 class="text-2xl md:text-4xl font-bold group-hover:text-black">IoT Smart Solutions</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black">Connecting the physical and digital worlds through intelligent automation.</p>
                </div>
            </a>
        </div>
    </section>
