...
<!-- Primary Meta Tags -->
<title>R4XN Discover - Explore Our Tools, Tech & Creative Solutions | Malaysia</title>
<meta name="description" content="Discover R4XN's unique technology stack, development tools, and creative solutions. 5+ years experience, 120+ interfaces, 99% client satisfaction. Explore our tech expertise." />
<meta name="keywords" content="R4XN discover, technology stack, development tools, creative solutions, frontend design, backend frameworks, modern web tech, Malaysia tech company, UI/UX design, mobile development, IoT solutions, web development tools" />
<meta name="author" content="R4XN Team" />
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="googlebot" content="index, follow" />
<meta name="bingbot" content="index, follow" />
<link rel="canonical" href="https://r4xn.com/discover" />
...
<meta property="og:title" content="R4XN Discover - Explore Our Tools, Tech & Creative Solutions" />
<meta property="og:description" content="Discover R4XN's technology stack, development tools, and creative solutions. 5+ years experience, 120+ interfaces, 99% client satisfaction. Explore our expertise." />
<meta property="og:url" content="https://r4xn.com/discover" />
<meta property="og:type" content="website" />
<meta property="og:image" content="https://r4xn.com/og-image.png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta property="og:image:alt" content="R4XN Discover - Technology Stack and Tools" />
...
<meta name="twitter:title" content="R4XN Discover - Explore Our Tools, Tech & Creative Solutions" />
<meta name="twitter:description" content="Discover R4XN's technology stack and development tools. 5+ years experience, 99% client satisfaction. Explore our expertise." />
<meta name="twitter:image" content="https://r4xn.com/og-image.png" />
<meta name="twitter:image:alt" content="R4XN Discover - Technology Stack and Tools" />
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "Modern development tools and frameworks for web and mobile applications"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Innovative approaches to building modern digital experiences"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Comprehensive toolkit for efficient software development"
        }
      }
    ]
  }
...
<script>
  ...
  gtag('config', 'G-CD69HEJBPY', {
    'page_title': 'R4XN Discover',
    'page_location': 'https://r4xn.com/discover'
  });
</script>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <script>
        ...
        <section class="min-h-screen px-6 py-10 md:px-32 md:py-10 flex flex-col items-center justify-center text-center text-black dark:text-white" role="region" aria-label="Technologies We Work With">
            ...
            <article id="card1" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden" role="listitem" itemscope itemtype="https://schema.org/Technology">
                ...
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
                    <svg viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 mx-auto text-black dark:text-white group-hover:text-orange-500 transition-colors duration-300 fill-current" aria-hidden="true">
                ...
                <p class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-black dark:text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" itemprop="name">
                    HTML5
                </p>
            </article>
            <div id="card2" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
                    <svg viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 mx-auto text-black dark:text-white group-hover:text-blue-500 transition-colors duration-300 fill-current"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title>CSS3 icon</title><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z"></path></g></svg>
                </div>
                <p class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-black dark:text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    CSS3
                </p>
            </div>
            <div id="card3" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
            ...
            <div id="card4" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
            ...
            <div id="card7" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
            ...
            <div id="card8" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
            ...
            <div id="card9" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
            ...
            <div id="card10" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
            ...
            <div id="card11" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
                    <svg viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 mx-auto text-black dark:text-white group-hover:text-[#21759B] transition-colors duration-300 fill-current"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title>WordPress icon</title><path d="M21.469 6.825c.84 1.537 1.318 3.3 1.318 5.175 0 3.979-2.156 7.456-5.363 9.325l3.295-9.527c.615-1.54.82-2.771.82-3.864 0-.405-.026-.78-.07-1.11m-7.981.105c.647-.03 1.232-.105 1.232-.105.582-.075.514-.93-.067-.899 0 0-1.755.135-2.88.135-1.064 0-2.85-.15-2.85-.15-.585-.03-.661.855-.075.885 0 0 .54.061 1.125.09l1.680 4.605-2.370 7.08L5.354 6.9c.649-.03 1.234-.1 1.234-.1.585-.075.516-.93-.065-.896 0 0-1.746.138-2.874.138-.2 0-.438-.008-.69-.015C4.911 3.15 8.235 1.215 12 1.215c2.809 0 5.365 1.072 7.286 2.833-.046-.003-.091-.009-.141-.009-1.06 0-1.812.923-1.812 1.914 0 .89.513 1.643 1.06 2.531.411.72.89 1.643.89 2.977 0 .915-.354 1.994-.821 3.479l-1.075 3.585-3.9-11.61.001.014zM12 22.784c-1.059 0-2.081-.153-3.048-.437l3.237-9.406 3.315 9.087c.024.053.05.101.078.149-1.120.393-2.325.609-3.582.609M1.211 12c0-1.564.336-3.05.935-4.39L7.29 21.709C3.694 19.96 1.212 16.271 1.211 12M12 0C5.385 0 0 5.385 0 12s5.385 12 12 12 12-5.385 12-12S18.615 0 12 0"></path></g></svg>
                </div>
                <p class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-black dark:text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Wordpress
                </p>
            </div>
            <div id="card12" class="tech-card group relative rounded-2xl p-10 transition duration-300 ease-in-out hover:shadow-xl cursor-pointer h-60 flex items-center justify-center bg-white dark:bg-[#121212] overflow-hidden">
                <div class="absolute inset-0 rounded-2xl border-[2.5px] border-transparent pointer-events-none animate-border"></div>
                <div class="relative z-10 transform transition duration-300 group-hover:-translate-y-2">
    ...
    <section class="min-h-[80vh] px-6 py-10 md:px-32 md:py-10 flex flex-col items-center justify-center text-center text-white">
        <div id="quoteBox" class="transition-all duration-700 opacity-100 transform translate-y-0 text-black dark:text-white 
                leading-tight font-medium text-4xl md:text-6xl mx-auto text-center">
    ...
    <section class="min-h-screen px-6 py-10 md:px-32 md:py-10 flex flex-col items-center justify-center text-white">
        <h2 class="work-heading text-transparent bg-gradient-to-t from-gray-600 to-black dark:from-gray-400 dark:to-white bg-clip-text leading-tight font-bold text-4xl lg:text-8xl mb-16 text-center">
            <div>Let's Work Together</div>
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div class="group flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white transition duration-300 h-full text-black dark:text-white dark:hover:text-black">
                ...
                <h3 class="text-2xl md:text-4xl font-bold">UI/UX <br>Design</h3>
                <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black dark:group-hover:text-black">Designing clean, intuitive, and user-friendly interfaces that elevate the experience.</p>
            </div>
            <div class="group flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white transition duration-300 h-full text-black dark:text-white dark:hover:text-black">
                ...
                <h3 class="text-2xl md:text-4xl font-bold">Website and App Design</h3>
                <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black dark:group-hover:text-black">Modern, responsive designs that look great and work seamlessly on all devices.</p>
            </div>
            <div class="group flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white transition duration-300 h-full text-black dark:text-white dark:hover:text-black">
                ...
                <h3 class="text-2xl md:text-4xl font-bold">IoT <br>Solutions</h3>
                <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black dark:group-hover:text-black">Smart systems that connect devices, collect data, and automate tasks.</p>
            </div>
            <div class="group flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white transition duration-300 h-full text-black dark:text-white dark:hover:text-black">
                ...
                <h3 class="text-2xl md:text-4xl font-bold">Website Development</h3>
                <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black dark:group-hover:text-black">Fast, secure, and scalable websites tailored to your business needs.</p>
            </div>
            <div class="group flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white transition duration-300 h-full text-black dark:text-white dark:hover:text-black">
                ...
                <h3 class="text-2xl md:text-4xl font-bold">Mobile App Development</h3>
                <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black dark:group-hover:text-black">Fast, secure, and scalable websites tailored to your business needs.</p>
            </div>
            <div class="group flex flex-col bg-white dark:bg-[#121212] p-10 space-y-8 rounded-3xl hover:bg-gray-200 dark:hover:bg-white transition duration-300 h-full text-black dark:text-white dark:hover:text-black">
                ...
                <h3 class="text-2xl md:text-4xl font-bold">Hosting & Deploy Services</h3>
                <p class="text-gray-600 dark:text-gray-400 text-xl group-hover:text-black dark:group-hover:text-black">We deploy and host your site with speed, security, and zero hassle.</p>
            </div>
        </div>
    </section>

    <script>
        // Function to update SVG gradient based on theme
        function updateSVGGradient() {
            const isDark = document.documentElement.classList.contains('dark');
            const svgElements = document.querySelectorAll('.main-icon, .ping-icon');
            
            svgElements.forEach(svg => {
                if (isDark) {
                    svg.setAttribute('stroke', 'url(#gradientTextDark)');
                } else {
                    svg.setAttribute('stroke', 'url(#gradientText)');
                }
            });
        }
