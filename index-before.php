...
<!-- Primary Meta Tags -->
<title>R4XN | Full-Stack Web & IoT Solutions for Modern Brands</title>
<meta name="description" content="R4XN transforms your digital ideas into powerful web platforms, mobile apps, and IoT systems—built with transparency and innovation." />
<meta name="keywords" content="R4XN, web development, IoT solutions, UI/UX design, system design, full-stack developer, frontend development, mobile apps, Malaysia tech, web design" />
...
<meta property="og:description" content="From idea to launch, we create seamless digital platforms—web, mobile, and IoT—with a focus on transparency, design, and results." />
<meta property="og:url" content="https://r4xn.com/" />
<meta property="og:type" content="website" />
<meta property="og:image" content="https://r4xn.com/og-image.jpg" />

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="R4XN – Full-Stack Web & IoT Solutions for Modern Brands" />
<meta name="twitter:description" content="Smart solutions in web, mobile, and IoT development—R4XN is your tech partner for modern growth." />
<meta name="twitter:image" content="https://r4xn.com/og-image.jpg" />
...
<section class="min-h-screen px-6 py-10 flex flex-col items-center justify-center text-center w-full space-y-20">
    ...
    <section class="min-h-screen px-6 py-10 flex flex-col items-center justify-center text-center w-full space-y-10">
        ...
        <p id="projectDesc" class="text-sm md:text-4xl max-w-4xl leading-tight text-gray-600 dark:text-[#737373] opacity-0 translate-y-20">
        ...
        <?php if ($image_path && $link_url): ?>
            <a href="<?= htmlspecialchars($link_url) ?>" target="_blank" rel="noopener noreferrer">
                <img id="projectImage" src="erp.r4xn.com/<?= htmlspecialchars($image_path) ?>" alt="Project Image" class="max-w-full w-full md:w-4/5 h-auto mx-auto rounded-[30px] shadow-lg opacity-0 rotate-12 scale-75">
            </a>
        <?php else: ?>
...
<section class="min-h-screen px-6 py-10 flex flex-col items-center justify-center text-center w-full space-y-6">
        ...
        <p id="shortDesc" class="text-sm md:text-4xl max-w-4xl text-gray-600 dark:text-[#737373] opacity-0 translate-y-10">
...
<section class="min-h-screen flex items-center justify-center w-full">
        <div id="innovateSection" class="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6 sm:px-12">
            <div id="innovateText" class="p-6 sm:p-12 opacity-0 translate-y-10 space-y-8">
                ...
                <p class="text-lg md:text-2xl text-gray-600 dark:text-[#737373] leading-relaxed">
                    Transform ideas into powerful digital experiences that inspire and engage. Let's build the future together.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-6">
                    <a href="mailto:r4xntech@gmail.com" class="px-8 py-5 w-full sm:w-60 text-center bg-black dark:bg-white text-white dark:text-black text-xl rounded-full hover:bg-gray-800 dark:hover:bg-gray-300 transition duration-300">
                        Start Building
                    </a>
                </div>
            </div>
