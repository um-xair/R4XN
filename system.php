...
<!-- Primary Meta Tags -->
<title>R4XN System Design - UI/UX Architecture That Performs | Malaysia</title>
<meta name="description" content="Discover R4XN's approach to UI/UX system design—merging structure, logic, and creativity into digital systems that users love. 5+ years experience, 120+ systems." />
<meta name="keywords" content="UI UX system design, system architecture, R4XN design process, structured interface, modern user experience, user flow, Malaysia UI UX designer, system design, user interface design" />
<meta name="author" content="R4XN Team" />
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="googlebot" content="index, follow" />
<meta name="bingbot" content="index, follow" />
<link rel="canonical" href="https://r4xn.com/system" />
...
<meta property="og:title" content="R4XN System Design - UI/UX Architecture That Performs" />
<meta property="og:description" content="Discover R4XN's approach to UI/UX system design—merging structure, logic, and creativity into digital systems that users love. 5+ years experience, 120+ systems." />
<meta property="og:url" content="https://r4xn.com/system" />
<meta property="og:type" content="website" />
<meta property="og:image" content="https://r4xn.com/og-image.png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta property="og:image:alt" content="R4XN System Design and UI/UX Architecture" />
...
<meta name="twitter:title" content="R4XN System Design - UI/UX Architecture That Performs" />
<meta name="twitter:description" content="Discover R4XN's approach to UI/UX system design. 5+ years experience, 120+ systems, 99% client satisfaction." />
<meta name="twitter:image" content="https://r4xn.com/og-image.png" />
<meta name="twitter:image:alt" content="R4XN System Design and UI/UX Architecture" />
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "System Design",
          "description": "UI/UX system design merging structure, logic, and creativity into digital systems"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Comprehensive system architecture for modern user experiences"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Structured interface design with elegant user flows and clear purpose"
        }
      }
    ]
  }
...
<script>
  ...
  gtag('config', 'G-CD69HEJBPY', {
    'page_title': 'R4XN System Design',
    'page_location': 'https://r4xn.com/system'
  });
</script>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main>
        <section class="container relative w-full min-h-screen flex flex-col items-center justify-center perspective-[900px]" role="region" aria-label="System Design Showcase" itemscope itemtype="https://schema.org/CreativeWork">
            <h1 class="sr-only" itemprop="name">R4XN System Design and UI/UX Architecture</h1>
            <div class="hi space-y-10">
                <div class="hi__cuboid">
                    <div class="face face--front"><p class="hi__word">SYSTEM</p></div>
                    <div class="face face--back"><p class="hi__word">SYSTEM</p></div>
                    <div class="face face--top"><p class="hi__word">SYSTEM</p></div>
                    <div class="face face--bottom"><p class="hi__word">SYSTEM</p></div>
                </div>
                <div class="hi__cuboid">
                    <div class="face face--front"><p class="hi__word">UI/UX</p></div>
                    <div class="face face--back"><p class="hi__word">UI/UX</p></div>
                    <div class="face face--top"><p class="hi__word">UI/UX</p></div>
                    <div class="face face--bottom"><p class="hi__word">UI/UX</p></div>
                </div>
                <div class="hi__cuboid">
                    <div class="face face--front"><p class="hi__word">DESIGN</p></div>
                    <div class="face face--back"><p class="hi__word">DESIGN</p></div>
                    <div class="face face--top"><p class="hi__word">DESIGN</p></div>
                    <div class="face face--bottom"><p class="hi__word">DESIGN</p></div>
                </div>
            </div>
            <div class="hi__base mt-10">
                <div class="hi__base-plate"></div>
                <p class="hi__location hi__location--lat lg:block hidden">53.3454N</p>
                <p class="hi__location hi__location--long lg:block hidden">-6.3070E</p>
            </div>
        </section>
    </main>
    ...
    <?php
        ...
        $result = $conn->query("SELECT * FROM system_projects ORDER BY id DESC");
        if (!$result) {
        ...
        if (empty($projects)) {
            echo "No system projects found in the database.";
        }
    ?>

        <section class="py-20 text-black dark:text-white text-center min-h-screen w-full flex flex-col items-center justify-center" role="region" aria-label="System Design Project Gallery">
            <h2 class="sr-only">System Design and UI/UX Projects</h2>
            <div id="parallaxContainer" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 p-5 w-full lg:w-[85%] mx-auto" role="list">
                <?php foreach ($projects as $project): ?>
                    <article class="relative group w-full h-full rounded-[20px] overflow-hidden transition-transform duration-300" role="listitem" itemscope itemtype="https://schema.org/CreativeWork">
                        <a href="<?= htmlspecialchars($project['link_url']) ?>" target="_blank" rel="noopener noreferrer"
                           class="block w-full h-full" itemprop="url" aria-label="View <?= htmlspecialchars($project['title']) ?> system design project">
                            <img src="erp.r4xn.com/<?= htmlspecialchars($project['image_path']) ?>" 
                                 alt="<?= htmlspecialchars($project['title']) ?> - System Design Project" 
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                <span class="text-white text-xl font-semibold relative" itemprop="name">
