...
<!-- Primary Meta Tags -->
<title>R4XN Frontend Development - Engaging, Responsive Interfaces | Malaysia</title>
<meta name="description" content="See how R4XN builds beautiful and responsive front-end solutions—crafted for speed, engagement, and usability on all devices. 5+ years experience, 120+ interfaces." />
<meta name="keywords" content="frontend development, R4XN, responsive web design, UI, interactive interface, Tailwind CSS, JavaScript, web apps, Malaysia frontend developer, React, Vue, modern web design" />
<meta name="author" content="R4XN Team" />
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="googlebot" content="index, follow" />
<meta name="bingbot" content="index, follow" />
<link rel="canonical" href="https://r4xn.com/frontend" />
...
<meta property="og:title" content="R4XN Frontend Development - Engaging, Responsive Interfaces" />
<meta property="og:description" content="See how R4XN builds beautiful and responsive front-end solutions—crafted for speed, engagement, and usability on all devices. 5+ years experience, 120+ interfaces." />
<meta property="og:url" content="https://r4xn.com/frontend" />
<meta property="og:type" content="website" />
<meta property="og:image" content="https://r4xn.com/og-image.png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta property="og:image:alt" content="R4XN Frontend Development Projects" />
...
<meta name="twitter:title" content="R4XN Frontend Development - Engaging, Responsive Interfaces" />
<meta name="twitter:description" content="See how R4XN builds beautiful and responsive front-end solutions. 5+ years experience, 120+ interfaces, 99% client satisfaction." />
<meta name="twitter:image" content="https://r4xn.com/og-image.png" />
<meta name="twitter:image:alt" content="R4XN Frontend Development Projects" />
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "Beautiful and responsive front-end solutions crafted for speed, engagement, and usability"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Modern web design that works perfectly on all devices and screen sizes"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Engaging user interfaces with modern technologies like Tailwind CSS, React, and Vue"
        }
      }
    ]
  }
...
<script>
  ...
  gtag('config', 'G-CD69HEJBPY', {
    'page_title': 'R4XN Frontend Development',
    'page_location': 'https://r4xn.com/frontend'
  });
</script>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main>
        <section class="container relative w-full min-h-screen flex flex-col items-center justify-center perspective-[900px]" role="region" aria-label="Frontend Projects Showcase" itemscope itemtype="https://schema.org/CreativeWork">
            <h1 class="sr-only" itemprop="name">R4XN Frontend Development Projects</h1>
    ...
    ?>
        ...
        <section class="py-20 text-black dark:text-white text-center min-h-screen w-full flex flex-col items-center justify-center" role="region" aria-label="Frontend Project Gallery">
            <h2 class="sr-only">Frontend Development Projects</h2>
            <div id="parallaxContainer" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 p-5 w-full lg:w-[85%] mx-auto" role="list">
                <?php foreach ($projects as $project): ?>
                    <article class="relative group w-full h-full aspect-[3/2] rounded-[20px] overflow-hidden transition-transform duration-300" role="listitem" itemscope itemtype="https://schema.org/CreativeWork">
                        <a href="<?= htmlspecialchars($project['link_url']) ?>" target="_blank" rel="noopener noreferrer"
                           class="block w-full h-full" itemprop="url" aria-label="View <?= htmlspecialchars($project['title']) ?> project">
                            <img src="erp.r4xn.com/<?= htmlspecialchars($project['image_path']) ?>" 
                                 alt="<?= htmlspecialchars($project['title']) ?> - Frontend Development Project" 
